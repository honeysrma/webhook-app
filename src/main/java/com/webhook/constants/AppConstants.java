...
public interface AppConstants {
	...
	String CALL_TRIGGER_API_URL = "call.trigger.api.url";
	String CALL_TRIGGER_API_HEADERS = "call.trigger.api.headers";
	String CALL_TRIGGER_API_CAMPID = "call.trigger.api.campid";
